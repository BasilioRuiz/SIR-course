...
w4=(spinor_wavelength(300:358)*10-15645.020)*1000.       ;line 8 + 5,6,12,13
in4=intarr(n_elements(w4))+8
si4=spinor_i(300:358) & sq4=spinor_q(300:417) & su4=spinor_u(300:417) & sv4=spinor_v(300:417)
str4=spinor_average_qsprofile(300:417)


w5=(spinor_wavelength(395:417)*10-15645.020)*1000.       ;line 8 + 5,6,12,13
in5=intarr(n_elements(w5))+8
si5=spinor_i(395:417) & sq5=spinor_q(395:417) & su5=spinor_u(395:417) & sv5=spinor_v(395:417)
str5=spinor_average_qsprofile(395:417)

stop

in=[in2,in3,in4] & w=[w2,w3,w4]
si=[si2,si3,si4] & sq=[sq2,sq3,sq4] & su=[su2,su3,su4] & sv=[sv2,sv3,sv4]
stri=[str2,str3,str4] & strq=stri*0.
